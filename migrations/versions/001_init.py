...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_data_organization_slug"), "organization", ["slug"], unique=True, schema="data"
    )
    op.create_table(
        "control",
        sa.Column("id", sa.UUID(), server_default=sa.text("uuidv7()"), nullable=False),
        ...
        sa.Column(
            "control_type",
            sa.Enum("TECHNICAL", "ORGANIZATIONAL", "PHYSICAL", name="controltype"),
            nullable=False,
        ),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        op.f("ix_lookup_control_code"), "control", ["code"], unique=True, schema="lookup"
    )
    op.create_table(
        "framework",
        sa.Column("id", sa.UUID(), server_default=sa.text("uuidv7()"), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "DEPRECATED", "DRAFT", name="frameworkstatus"),
            nullable=False,
        ),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        op.f("ix_lookup_framework_code"), "framework", ["code"], unique=False, schema="lookup"
    )
    op.create_table(
        "evidence",
        sa.Column("id", sa.UUID(), server_default=sa.text("uuidv7()"), nullable=False),
        ...
        sa.Column(
            "source",
            sa.Enum("MANUAL", "AWS", "GITHUB", "OKTA", "OTHER", name="evidencesource"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "NOT_STARTED", "IN_PROGRESS", "COMPLETE", "NOT_APPLICABLE", name="compliancestatus"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["framework_control_id"], ["lookup.frameworkcontrol.id"], ondelete="CASCADE"
        ),
